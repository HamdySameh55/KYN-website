  ...
  return (
    <div style={containerStyle}>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 3, repeat: Infinity, delay: index * 0.3, ease: "linear" }}
              />
            </motion.div>
          ))}
        </div>
      ...
      >
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} style={{ display: "inline-block", position: "relative", zIndex: 9999, pointerEvents: "auto" }}>
          <button
